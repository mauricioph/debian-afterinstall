...
apt install blender blender-data blueman  bluetooth bluez bluez-obexd python-psutil python-power upower x11-xserver-utils mkvtoolnix-gui mplayer lsdvd libdvd-pkg aegisub dos2unix squashfs-tools obs-plugins obs-studio libavcodec-extra ffmpeg pavucontrol audacity mixxx ncmpcpp -y
