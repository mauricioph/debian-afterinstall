...
apt install synaptic apt-xapian-index arandr asciinema atomicparsley  btrfs-progs build-essential busybox bzip2 bzip2-doc ca-certificates  ca-certificates-java ca-certificates-mono cabextract calf-plugins calibre calibre-bin gdebi gksu yad apt-show-versions libio-pty-perl libauthen-pam-perl asciidoc xmlto uuid-dev libattr1-dev e2fsprogs f2fs-tools hfsutils hfsprogs jfsutils reiser4progs xfsprogs xfsdump lm-sensors upower zlib1g-dev libacl1-dev e2fslibs-dev libblkid-dev liblzo2-dev macfanctld unrar htop rofi feh compton unclutter nbtscan nmap i3lock zathura suckless-tools surf puddletag sonata alarm-clock-applet lightdm-gtk-greeter lightdm-gtk-greeter-settings ccd2iso cdparanoia cdrdao certbot cgroupfs-mount light-locker -y
...
apt install fontconfig fontconfig-config fonts-cantarell fonts-crosextra-caladea fonts-crosextra-carlito fonts-dejavu fonts-dejavu-core fonts-dejavu-extra fonts-droid-fallback fonts-font-awesome fonts-freefont-ttf fonts-glewlwyd fonts-glyphicons-halflings fonts-inter fonts-lato fonts-liberation fonts-liberation2 fonts-linuxlibertine fonts-lyx fonts-mathjax fonts-noto fonts-noto-cjk fonts-noto-cjk-extra fonts-noto-color-emoji fonts-noto-core fonts-noto-extra fonts-noto-hinted fonts-noto-mono fonts-noto-ui-core fonts-noto-ui-extra fonts-noto-unhinted fonts-opensymbol fonts-quicksand fonts-roboto-hinted fonts-roboto-unhinted fonts-sil-gentium fonts-sil-gentium-basic fonts-symbola fonts-urw-base35 fonts-wine ttf-bitstream-vera ttf-dejavu-core ttf-freefont ttf-mscorefonts-installer tzdata -y

echo "Instaling miscelaneuos"
apt install chromium chromium-common chromium-lwn4chrome chromium-sandbox chromium-tt-rss-notifier cinnamon-desktop-data cinnamon-l10n cmake cmake-data cmospwd code collectd-core colord colord-data comerr-dev:amd64 comprez compton conky conky-all conky-std console-setup console-setup-linux coreutils cups cups-browsed cups-bsd cups-client cups-common cups-core-drivers cups-daemon cups-filters cups-filters-core-drivers cups-ipp-utils cups-pk-helper cups-ppdc cups-server-common curl darkslide darktable dash davfs2 deluge deluge-common deluge-gtk dos2unix dosfstools dunst dvdauthor e2fsprogs e2fsprogs-l10n easy-rsa easytag ebook-speaker efibootmgr eject exfat-utils exif exifprobe exiftags exiftran f2fs-tools facedetect fakeroot fatcat fdisk fdupes feh ffmpeg fgallery 
apt install firefox-esr firmware-amd-graphics firmware-b43-installer firmware-linux firmware-linux-free firmware-linux-nonfree firmware-misc-nonfree flac flactag flasm flatpak flowblade foomatic-db-compressed-ppds foomatic-db-engine foremost forensics-extra four-in-a-row freepats freerdp2-dev freetype2-doc frei0r-plugins ftp funcoeszz fuse fuse3 fwupd fwupd-amd64-signed ufw unar unattended-upgrades unrar unrar-free unzip update-glx
apt install gdebi gdebi-core gdisk geany geany-common geany-plugin-gproject geany-plugin-projectorganizer geany-plugins-common genisoimage gimp gimp-data gimp-data-extras git git-man gjacktransport gksu glade gladish glx-alternative-mesa gmic gnupg gnupg-agent gnupg-l10n gnupg-utils google-chrome-stable gparted gparted-common gperf gpg gpg-agent gpg-wks-client gpg-wks-server gpgconf gpgsm gpgv xscreensaver xscreensaver-data xserver-common xserver-xephyr xserver-xorg xserver-xorg-core xserver-xorg-input-all xserver-xorg-input-libinput xserver-xorg-input-wacom xserver-xorg-legacy xserver-xorg-video-all xserver-xorg-video-fbdev xserver-xorg-video-intel xserver-xorg-video-vesa  xterm xtightvncviewer xtrans-dev xxd xz-utils
apt install growisofs grub-common grub-efi grub-efi-amd64 grub-efi-amd64-bin grub-efi-amd64-dbg grub-efi-amd64-signed grub-pc grub2-common gsfonts harvid hcxdumptool hddtemp hdparm heartbleeder hexcompare hexedit hfsprogs hfsutils hicolor-icon-theme hitori horst hostname hping3 hplip hplip-data htop httrack hunspell-en-gb hunspell-en-us hwdata hwinfo i965-va-driver:amd64 imagemagick imagemagick-6-common imagemagick-6.q16 zathura zathura-cb zathura-djvu zathura-pdf-poppler zathura-ps zbackup zeitgeist-core zenity zenity-common zip zlib1g  zlib1g-dev  zoom zpaq
apt install initramfs-tools initramfs-tools-core inkscape install-info installation-report intel-media-va-driver-non-free:amd64 intel-microcode intltool-debian jack jack-mixer jackd jackd2 jackd2-firewire jackeq jamin japa java-common javascript-common jdupes john john-data kbd keyboard-configuration keyutils kmod kodi kodi-addons-dev:amd64 kodi-bin kodi-data kodi-eventclients-common kodi-eventclients-dev kodi-eventclients-kodi-send kodi-eventclients-ps3 kodi-eventclients-wiiremote kodi-repository-kodi kodi-visualization-spectrum:amd64 kodi-x11 krita krita-data
apt install ladish laditools lame laptop-detect lbry lsb-base lsb-release lsdvd lshw lsof lua-bitop  lua-cjson  lua-expat  lua-json lua-lpeg  lua-socket  lua5.3 lvm2 lxappearance lxappearance-obconf lxc lxcfs lxde lxde-common lxde-core lxde-icon-theme lxde-settings-daemon lxhotkey-core lxhotkey-data lxhotkey-gtk lxhotkey-plugin-openbox lxinput lxlauncher lxlock lxmenu-data lxmusic lxpanel lxpanel-data lxpolkit lxrandr lxsession lxsession-data lxsession-default-apps lxsession-edit lxsession-logout lxtask lxterminal lynis lynx lynx-common lz4 lzop m4 macfanctld macutils mailutils mailutils-common make man-db manpages manpages-dev mariadb-client-10.1 mariadb-client-10.3 mariadb-client-core-10.3 mariadb-common mcomix mdns-scan media-player-info mediainfo mediainfo-gui membernator memstat mencoder menu menu-xdg 
apt install mesa-utils mesa-va-drivers  mesa-vdpau-drivers  meson mime-support min minissdpd minizip mixxx mixxx-data mkvtoolnix mkvtoolnix-gui moreutils mp3info mpack mpc mpd mpg123 mpg321 mplayer mplayer-gui mplayer-skin-blue mps-youtube mpv mscompress mtools nano nasm nast nbtscan ncmpcpp ncompress ncurses-base ncurses-bin ncurses-term ndiff nemo nemo-data nemo-fileroller nemo-gtkhash nemo-python net-tools netbase netcat-openbsd netcat-traditional netdiscover netpbm network-manager network-manager-gnome nfs-common nftables ngrep ninja-build nmap nmap-common node-highlight.js node-html5shiv node-jquery node-normalize.css nodejs nodejs-doc nomarch notification-daemon notify-osd nstreams ntfs-3g ntfs-3g-dev ntfs-config 
...
apt install libreoffice scrot feh swftools ghostscript pdftohtml ffmpeg tesseract-ocr tesseract-ocr-eng clamav imagemagick ghostscript file-roller evince qalculate clementine vlc v4l-utils v4l2loopback-dkms va-driver-all  vbetool vdpau-driver-all  vim-common vim-tiny vinagre vino virtualenv virtualenvwrapper vlc vlc-bin vlc-data vlc-l10n vlc-plugin-access-extra  vlc-plugin-base  vlc-plugin-fluidsynth  vlc-plugin-jack  vlc-plugin-notify  vlc-plugin-qt  vlc-plugin-samba  vlc-plugin-skins2  vlc-plugin-svg  vlc-plugin-video-output  vlc-plugin-video-splitter  vlc-plugin-visualization  vorbis-tools gimp shotwell gparted gnome-disk-utility libreoffice-writer libreoffice-calc libreoffice-impress -y

echo "Installing Media apps"
apt install blender blender-data blueman  bluetooth bluez bluez-obexd python-psutil python-netifaces python-requests python-power upower x11-xserver-utils mkvtoolnix-gui mplayer lsdvd libdvdcss2 aegisub dos2unix squashfs-tools obs-plugins obs-studio libavcodec-extra ffmpeg pavucontrol audacity jackd mixxx ncmpcpp -y
